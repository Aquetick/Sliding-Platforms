...
public class PlatformRegistry extends PersistentState {

    private static final String STATE_ID = "slidingplatforms_platform_registry";

    private static final Map<RegistryKey<World>, Map<BlockPos, String>> MAP = new HashMap<>();

    private static final Pattern AUTO_NAME = Pattern.compile("^(?:Контроллер|Controller) (\\d+)$");
